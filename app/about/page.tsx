...
const INTEGRATIONS = [
  { name:'ЕАТ «Берёзка»', desc:'Закупка малого объёма, закупки малого объёма до 600 тыс. руб.', status:'Поддерживается', color:'bg-green-100 text-green-700' },
  ...
  { name:'ЕИС 3.0', desc:'Взаимодействие с внешними системами, интеграция с ЕИС', status:'В разработке', color:'bg-yellow-100 text-yellow-700' },
  { name:'ФЭО (ФЭО)', desc:'Платёжные поручения и финансовые реестры', status:'Поддерживается', color:'bg-green-100 text-green-700' },
];
