...
const INTEGRATIONS = [
  ...
  { name:'ЕИС 3.0', url:'smev.gosuslugi.ru', basis:'Постановление Правительства РФ от 08.09.2010 № 697', status:'Планируется' },
  { name:'ФЭО (ФЭО)', url:'sufd.id.gov.ru', basis:'Приказ Казначейства от 29.12.2012 № 24н', status:'Поддерживается' },
];
...
const LEGAL = [
  ...
  'Приказ Федерального ФЭО № 206н от 15.12.2021',
];
