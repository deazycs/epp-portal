...
const PAYMENT_STATUSES = ['payment','payment_docs','payment_done','payment_done','execution','eis_reporting','archive'];
      ...
      <div className="p-3 sm:p-4 fade-in">
        ...
        <div className="gov-alert gov-alert-info mb-3 text-xs">
          ...
          <span>
            ...
            Пикинер О.В. (ФЭО) видит сумму, поставщика и реквизиты договора — всё из карточки закупки.
          </span>
        </div>
