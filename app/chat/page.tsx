...
const INITIAL_CHATS: Chat[] = [
  {
    ...
    unread: 0,
    messages: [
      { id: 'm1', from: 'Петров А.В.', text: 'Коллеги, картриджи для принтеров придут в пятницу. Прошу подготовить места для приёмки.', time: '10:30', mine: true },
      { id: 'm2', from: 'Орлова Т.В.', text: 'Принято. Склад готов.', time: '10:32', mine: false },
      { id: 'm3', from: 'Никитин П.А.', text: 'Подтверждаю — 3 ящика по ТЗ.', time: '10:35', mine: false },
    ],
  },
  {
    id: 'c2',
    ...
    unread: 1,
    messages: [
      { id: 'm4', from: 'Смирнова Н.С.', text: 'Андрей Викторович, пришлите ТЗ на картриджи на согласование.', time: '09:15', mine: false },
      { id: 'm5', from: 'Петров А.В.', text: 'Наталья Сергеевна, направил на почту. Также прикрепил в карточке закупки РЗ-2026-00142.', time: '09:22', mine: true },
      { id: 'm6', from: 'Смирнова Н.С.', text: 'Получила, посмотрю до обеда.', time: '09:23', mine: false },
      { id: 'm7', from: 'Смирнова Н.С.', text: 'Согласовала. Можете размещать в Берёзке.', time: '11:45', mine: false },
    ],
  },
  {
    id: 'c3',
    ...
    unread: 0,
    messages: [
      { id: 'm8', from: 'Козлов Д.М.', text: 'Договор по серверам подписан. Оригинал у меня, передам сегодня.', time: 'Вчера', mine: false },
      { id: 'm9', from: 'Петров А.В.', text: 'Отлично, спасибо! Как получу — передам в бухгалтерию.', time: 'Вчера', mine: true },
    ],
  },
  {
    id: 'c4',
    ...
    unread: 0,
    messages: [
      { id: 'm10', from: 'Никитин П.А.', text: 'Запросил КП у трёх поставщиков по серверам. Жду ответов до пятницы.', time: 'Пн', mine: false },
      { id: 'm11', from: 'Петров А.В.', text: 'Принято. Как получим — сделаем расчёт НМЦК.', time: 'Пн', mine: true },
      { id: 'm12', from: 'Козлов Д.М.', text: 'Проект договора уже готов, жду итогов торгов.', time: 'Вт', mine: false },
    ],
  },
];
