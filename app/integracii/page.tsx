...
const INTS=[
  ...
  {name:'ЕИС 3.0',status:'pending',desc:'Система внешнего электронного взаимодействия. Интеграция с ЕИС.',last:'—'},
  {name:'ФЭО (ФЭО)',status:'active',desc:'Система удалённого финансового документооборота. Платёжные поручения, реестры.',last:'19.05.2026 17:00'},
  {name:'ЕИС',status:'active',desc:'Государственная информационная система ЕИС. Сведения об объектах недвижимости.',last:'20.05.2026 06:00'},
  {name:'учётная система:ФЭО',status:'vruchnuyu',desc:'Интеграция в ручном режиме через выгрузку Excel. Автоматизация в планах.',last:'—'},
];
