...
export const MOCK_PROCUREMENTS: Procurement[] = [
  {
    ...
    initiatorId: 'u6', initiatorName: 'Митусов С.А.',
    responsibleId: 'u1', responsibleName: 'Швецов К.Е.',
  ...
  },
  {
    ...
    initiatorId: 'u6', initiatorName: 'Митусов С.А.',
    responsibleId: 'u3', responsibleName: 'Болдина А.В.',
  ...
  },
  {
    ...
    riskLevel: 'low',
    departmentId: 'd1', departmentName: 'Отдел МТО',
    initiatorId: 'u7', initiatorName: 'Давыдова Ф.А.',
    responsibleId: 'u1', responsibleName: 'Швецов К.Е.',
    plannedSum: 375000,
  ...
  },
  {
    ...
    riskLevel: 'low',
    departmentId: 'd1', departmentName: 'Отдел МТО',
    initiatorId: 'u1', initiatorName: 'Швецов К.Е.',
    responsibleId: 'u1', responsibleName: 'Швецов К.Е.',
  ...
  },
  {
    ...
    departmentId: 'd4', departmentName: 'ИТ-отдел',
    initiatorId: 'u6', initiatorName: 'Митусов С.А.',
    responsibleId: 'u6', responsibleName: 'Митусов С.А.',
    plannedSum: 1850000,
    budgetCode: '051', kbk: '321 0412 54 4 01 90020 243', kosgu: '226',
    financingSource: 'Федеральный бюджет',
    procurementType: 'services',
  ...
  },
  {
    ...
    departmentId: 'd1', departmentName: 'Отдел МТО',
    initiatorId: 'u7', initiatorName: 'Давыдова Ф.А.',
    responsibleId: 'u7', responsibleName: 'Давыдова Ф.А.',
