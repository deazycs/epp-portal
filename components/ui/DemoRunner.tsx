...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    role: 'Петров А.В. · Специалист МТО',
    what: 'Вводим: «Поставка картриджей для принтеров и МФУ (II кв. 2026)». Добавляем 4 позиции — картриджи HP, Canon, Samsung, Epson с количеством и ценами. Система автоматически считает НМЦК: 162 000 руб.',
    why: 'Автоматический расчёт НМЦК исключает арифметические ошибки. Позиционный учёт позволяет потом контролировать частичную поставку.',
    highlight: 'При вводе цены и количества — итоговая сумма пересчитывается мгновенно',
    duration: 7000,
  },
  ...
  },
  {
    route: '/ispolnenie',
    block: '🚚 Исполнение', blockNum: 6,
    title: 'Реестр исполнений — прогресс по позициям',
    role: 'Петров А.В. · Специалист МТО',
    what: 'Открываем «Исполнение договоров». Видим карточку РЗ-2026-00142/Д: поставлено 12 картриджей HP из 28, все 20 Canon. Прогресс-бар: 45%. Система покажет отставание если поставка не завершится в срок.',
    why: 'Позиционный контроль исполнения: видно не просто «в работе», а конкретно что поставлено и что ещё ожидается. Приёмочной комиссии проще принимать товар.',
    highlight: 'Прогресс-бары по каждой позиции — в детальной панели справа',
    duration: 7000,
  },
  {
    route: '/zakupki/p001',
  ...
  // ── БЛОК 7: ОПЛАТА И ЗАКРЫТИЕ ──────────────
  {
    ...
    what: 'Получены документы: счёт №ТО-2026-0147 на 156 400 руб., накладная, акт выполненных работ. Волкова Е.И. видит задачу в своём разделе. Оформляет платёжное поручение через СУФД. Статус закупки — «Оплата».',
  ...
  },
  {
    ...
    what: 'Мы прошли полный цикл закупки — от служебной записки до архива — через 14 этапов, 25 шагов, с участием 5 сотрудников. В реальном МТО Росреестра это занимает 1-2 месяца. В ЕПП каждый этап прозрачен, контролируем и задокументирован.',
