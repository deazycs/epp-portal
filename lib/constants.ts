...
export const WORKFLOW_STATUS_LABELS: Record<string, string> = {
  ...
  payment:            'Оплата (документы)',
  payment_docs:       'Документы в ФЭО',
  payment_sufd:       'Казначейство (СУФД)',
  payment_done:       'Оплачено (1С)',
...
export const WORKFLOW_STATUS_COLORS: Record<string, string> = {
  ...
  payment_sufd:       'bg-orange-50 text-orange-800 border-orange-300',
